 ...
 */
final class Version20211209175520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offresindividuel AS SELECT id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel FROM offresindividuel');
        $this->addSql('DROP TABLE offresindividuel');
        $this->addSql('CREATE TABLE offresindividuel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, offresindividuel_id INTEGER NOT NULL, descriptif_individuel VARCHAR(255) NOT NULL COLLATE BINARY, expiration DATE NOT NULL, prix_individuel VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_4227432624DF568D FOREIGN KEY (offresindividuel_id) REFERENCES offres (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO offresindividuel (id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel) SELECT id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel FROM __temp__offresindividuel');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offresindividuel AS SELECT id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel FROM offresindividuel');
        $this->addSql('DROP TABLE offresindividuel');
        $this->addSql('CREATE TABLE offresindividuel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, offresindividuel_id INTEGER NOT NULL, descriptif_individuel VARCHAR(255) NOT NULL, expiration DATE NOT NULL, prix_individuel VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO offresindividuel (id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel) SELECT id, offresindividuel_id, descriptif_individuel, expiration, prix_individuel FROM __temp__offresindividuel');
        $this->addSql('DROP TABLE __temp__offresindividuel');
        $this->addSql('CREATE INDEX IDX_4227432624DF568D ON offresindividuel (offresindividuel_id)');
    }
